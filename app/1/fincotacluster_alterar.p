...
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "Cluster nao cadastrado".
...
do on error undo:
    find fincotacluster where fincotacluster.fcccod = ttentrada.fcccod exclusive no-error.
    fincotacluster.fccnom = ttentrada.fccnom. 
end.

create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "Cluster alterado com sucesso".
